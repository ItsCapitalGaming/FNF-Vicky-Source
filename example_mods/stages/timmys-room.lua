...
function onCreate()
    ...
    setProperty('gfGroup.visible', true)
        ...
        makeLuaSprite('timmys_room', 'timmys_room', -600, -300);

	addLuaSprite('timmys_room', false);

        makeLuaSprite('la_cama_de_juan', 'la_cama_de_juan', -650, -350);

	addLuaSprite('la_cama_de_juan', true);
